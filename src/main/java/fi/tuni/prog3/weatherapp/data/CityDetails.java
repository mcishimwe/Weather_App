...
/**
 * Represents detailed information about a city, including its ID, name,
 * geographical coordinates, country, population, timezone, and times for
 * sunrise and sunset.
 *
 * @author ivanperov
 */
public class CityDetails {
    ...
    private Coord coord;      // Geographical coordinates of the city
    private String country;   // Country code of the city
    private int population;   // Population of the city
    private int timezone;     // Timezone offset from UTC for the city
    private long sunrise;     // Sunrise time in Unix format
    private long sunset;      // Sunset time in Unix format
